...
impl AccountPrivKey {
    ...
    pub fn to_bytes(&self) -> Vec<u8> {
        ...
        let res = xprv_bytes.split_off(Prefix::LENGTH);
        #[cfg(feature = "zeroize")]
        {
            let cap = xprv_bytes.capacity();
            xprv_bytes.resize(cap, 0);
            zeroize::Zeroize::zeroize(&mut xprv_bytes);
        }
        res
    }
...
impl AccountPubKey {
    ...
    pub fn ovks_for_shielding(&self) -> (InternalOvk, ExternalOvk) {
        ...
        #[cfg(feature = "zeroize")]
        zeroize::Zeroize::zeroize(&mut i_ovk);

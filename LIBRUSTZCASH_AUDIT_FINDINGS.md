...
4. Full lightwalletd malformed-input surface beyond the currently fixed fields.
...
5. Native verifier vs helper-path mismatches around RedJubjub / RedPallas randomized keys.
